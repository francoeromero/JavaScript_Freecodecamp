...
function sum(arr, n) {
  if (n <= 0) { // condición de parada, se detiene la recursión si n es menor o igual a 0
      return 0; //si se usa return 1, entonces se estaria devolviendo un valor fijo y no la suma de los elementos del arreglo.
  } else {
...
console.log(sum([1, 2, 3, 4, 5], 3)); // me da 6